---
description: Technical Tutorial Writing and Documentation and Status Updates
alwaysApply: false
---
# Technical Tutorials
...
- Start with the technical content immediately. Avoid broad introductions.
- Use a direct, matter-of-fact tone. Write as if explaining to a peer developer.
- Focus on the 'how' and 'why' of implementations. Explain technical decisions.
- Avoid repeating adjectives or adverbs.
...
- Begin each main section with a brief (1-2 sentence) overview.
...
- Don't use cliché phrases like 'In today's [x] world'.
...
- If appropriate, mention potential challenges or areas for improvement.
- Keep the conclusion concise and focused on the practical implications.
- Max 4 sentences and 2 paragraphs.
...
- Guide the reader through the entire implementation process.

Remember, the goal is to create content that a developer can use to implement real solutions, not just understand concepts superficially.
